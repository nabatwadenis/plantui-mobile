    ...
    return const Scaffold(
      body: Padding(
        ...
        child: Column(
          children: [
            Center(
              child: Text("Let's plant with Us", textAlign: TextAlign.center, style: TextStyle(
                fontSize: 30.0,
                fontWeight: FontWeight.bold
              ),),
            ),
            Center(
              child: Text("make the world green again", textAlign: TextAlign.center, style: TextStyle(
                  fontSize: 25.0,
